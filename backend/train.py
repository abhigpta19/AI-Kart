...
Original file is located at
    https://colab.research.google.com/github/bnsreenu/python_for_microscopists/blob/master/309_Training_your_own_Chatbot_using_GPT%E2%80%8B.ipynb
...
def main():
    directory ="app/data"  # Replace with the path to your directory containing the files
    model_output_path = "app/model_1"
    ...
    # Test the chatbot
    prompt = " "  # Replace with your desired prompt
